class GoogleMapBlock < SirTrevorRails::Block
  ...
  def getsolr
	...
	res = solr.get 'select', :params => {
	  ...
	  :start=>0,
	  :rows=>1000,
	  :fl=> ["id", "spotlight_exhibit_slugs_ssim", "full_title_tesim", "spotlight_upload_description_tesim", "thumbnail_url_ssm", "blacklight-location_ssim", "exhibit_#{exhibit_id}_location_ssim"],
