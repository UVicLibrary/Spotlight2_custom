...
module Spotlight
  ...
  class IiifManifestPresenter
    ...
    delegate :id, :uploaded_resource, to: :resource # This is actually a SolrDocument, not a Spotlight::Resource
    delegate :blacklight_config, to: :controller

    attr_accessor :resource, :controller

    def initialize(resource, controller)
      @resource = resource # This is actually a SolrDocument, not a Spotlight::Resource
